...
class Settings(BaseSettings):
    ...
    detection_min_track_hits: int = 2
    ...
    auto_count_session_lookahead_ms: int = 70000
    count_entry_confirm_frames: int = 2
    count_exit_confirm_frames: int = 2
    count_line_cooldown_frames: int = 10
    count_process_after_session: bool = True
    count_publish_live_updates: bool = False
    count_frame_sample_interval_ms: int = 100
    count_recorded_frame_jpeg_quality: int = 95
    count_max_recorded_frames: int = 900
    count_prewarm_seconds: int = 8
    count_region_padding_x: float = 0.04
    count_region_padding_y: float = 0.06
    cors_origins: str = "*"
